<div class="admin-reaction">
    <ul>
        <li>
            ...
            </svg> : <span><?php echo exam_reaction_button_count_by_post_and_react_id( $post_id,1 ) ?></span></li>
        <li><svg fill="#183153" height="64px" width="64px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 330 330" xml:space="preserve">
            ...
            </svg> : <span><?php echo exam_reaction_button_count_by_post_and_react_id( $post_id,2 ) ?></span></li>
        <li><svg fill="#FF2500" height="64px" width="64px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 330 330" xml:space="preserve">
                <g id="SVGRepo_bgCarrier" stroke-width="0"/>
                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"/>
            ...
            </svg> : <span><?php echo exam_reaction_button_count_by_post_and_react_id( $post_id,3 ) ?></span></li>
    </ul>
</div>